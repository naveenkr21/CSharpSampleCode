...
{
 public   class SimpleDocProcessor : DocumentProcessorBase, IDocumentProcessor, IDisposable
    {
        ...
        public SimpleDocProcessor(DirectoryInfo _CurDirtoProcess, List<string> _ValidExtentions)
        {
